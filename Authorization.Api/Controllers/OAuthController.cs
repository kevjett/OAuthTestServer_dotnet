...
namespace Authorization.Api.Controllers
{
    public class OAuthController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            ViewBag.CreateUrl = string.Format("{0}/User/SignUp?returnUrl={1}", Config.SiteUrl,
                    Url.Encode(returnUrl));
            ViewBag.ForgotPasswordUrl = string.Format("{0}/User/ForgotPassword?returnUrl={1}", Config.SiteUrl,
                    Url.Encode(returnUrl));
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            try
            {
                ...
                string encryptionKey = Config.OAuth_ResourceAuthenticationKey;
