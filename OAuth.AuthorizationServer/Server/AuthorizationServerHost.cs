...
namespace OAuth.AuthorizationServer.Server
{
    ...
    public class AuthorizationServerHost : IAuthorizationServerHost
    {
        ...
        public ICryptoKeyStore CryptoKeyStore { get { return _SymmetricCryptoKeyService; } }
        ...
        {
            var accessToken = new AuthorizationServerAccessToken { Lifetime = TimeSpan.FromDays(60) }; // could parameterize lifetime
        ...
        {
            throw new NotImplementedException("Not implemented due to security concerns with Password Grant Type");
