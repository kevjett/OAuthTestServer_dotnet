...
{
    public class OAuth_Client : IClientDescription
    {
        public OAuth_Client(DbTable.OAuth_Client client)
        {
            Client = client;
        }

        public DbTable.OAuth_Client Client { get; set; }
        public IList<DbTable.OAuth_Scope> Scopes { get; set; }
